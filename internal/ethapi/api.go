...
func (s *PublicTransactionPoolAPI,m *PublicTxPoolAPI ) GetTransactionByHash01(ctx context.Context, hash common.Hash) (*RPCTransaction, error) {
	borTx := false
	pending, queue := m.b.TxPoolContent()
